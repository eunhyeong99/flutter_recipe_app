      ...
      children: [
        Expanded(
          child: GestureDetector(
            child: selectedIndex == 0 ? _SelectedTab(text: labels[0]) : _UnSelectedTab(text: labels[1]),
            onTap: () {
              onChange(0);
            },
          ),
        ...
        Expanded(
          child: GestureDetector(
            ...
            child: selectedIndex == 1 ? _SelectedTab(text: labels[0]) : _UnSelectedTab(text: labels[1]),
          ),
        ),
      ],
    );
        ...
        children: [
          Text(
            ...
            style: TextStyles.smallerTextBold
                .copyWith(color: ColorStyles.primary80),
          ),
        ],
      ),
    );
